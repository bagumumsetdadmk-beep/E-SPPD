...
CREATE TABLE public.assignment_letters (
    ...
    date DATE NOT NULL,
    basis TEXT,
    employee_ids TEXT[], -- Array of Employee IDs
    subject TEXT,
...
CREATE TABLE public.sppds (
    id TEXT PRIMARY KEY,
    assignment_id TEXT REFERENCES public.assignment_letters(id),
    start_date DATE,
    end_date DATE,
    status TEXT,
...
CREATE TABLE public.receipts (
    id TEXT PRIMARY KEY,
    sppd_id TEXT REFERENCES public.sppds(id),
    date DATE,
...
CREATE POLICY "Public access" ON public.agency_settings FOR ALL USING (true);
CREATE POLICY "Public access" ON public.employees FOR ALL USING (true);
CREATE POLICY "Public access" ON public.cities FOR ALL USING (true);
CREATE POLICY "Public access" ON public.funding_sources FOR ALL USING (true);
CREATE POLICY "Public access" ON public.transport_modes FOR ALL USING (true);
CREATE POLICY "Public access" ON public.signatories FOR ALL USING (true);
CREATE POLICY "Public access" ON public.assignment_letters FOR ALL USING (true);
CREATE POLICY "Public access" ON public.sppds FOR ALL USING (true);
CREATE POLICY "Public access" ON public.receipts FOR ALL USING (true);
CREATE POLICY "Public access" ON public.travel_reports FOR ALL USING (true);
`}</pre>
                  </div>
